...
const MainAppPage = () => {
  ...
  useEffect(() => {
    ...
    return (
      console.log("great useEffect work has done here. because this component lifecycle has benn ended")
    );
  ...
  return (
    <>
      {/* form */}
	<h1 style={{taxtAlign: 'center'}}> Fibonacci Calculator Version 3 </h1>
